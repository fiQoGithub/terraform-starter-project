...
variable "sg_name" {
  ...
  type        = string
  default     = "shafiq-sg-allow-http-https-ssh-from-anywhere"
}
...
variable "ec2_name" {
  ...
  type        = string
  default     = "my-sample-ec2-shafiq-from-tf" # Replace with your preferred EC2 Instance Name 
}
...
variable "key_name" {
  ...
  type        = string
  default     = "shafiq" # Replace with your own key pair name (without .pem extension) that you have downloaded from AWS console previously
}
